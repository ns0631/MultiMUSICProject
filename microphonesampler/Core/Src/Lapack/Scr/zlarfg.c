...
/*  ZLARFG generates a fcomplex elementary reflector H of order n, such */
/*  that */
...
/*  (n-1)-element fcomplex vector. H is represented in the form */

/*        H = I - tau * ( 1 ) * ( 1 v' ) , */
/*                      ( v ) */

/*  where tau is a fcomplex scalar and v is a fcomplex (n-1)-element */
