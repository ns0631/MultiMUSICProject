...
/* Subroutine */ int caxpy_(integer *n, fcomplex *ca, fcomplex *cx, integer *
	incx, fcomplex *cy, integer *incy);

/* Subroutine */ int ccopy_(integer *n, fcomplex *cx, integer *incx, fcomplex *
	cy, integer *incy);

/* fcomplex */ VOID cdotc_(fcomplex * ret_val, integer *n, fcomplex *cx, integer 
	*incx, fcomplex *cy, integer *incy);

/* fcomplex */ VOID cdotu_(fcomplex * ret_val, integer *n, fcomplex *cx, integer 
	*incx, fcomplex *cy, integer *incy);

/* Subroutine */ int cgbmv_(char *trans, integer *m, integer *n, integer *kl, 
	integer *ku, fcomplex *alpha, fcomplex *a, integer *lda, fcomplex *x, 
	integer *incx, fcomplex *beta, fcomplex *y, integer *incy);

/* Subroutine */ int cgemm_(char *transa, char *transb, integer *m, integer *
	n, integer *k, fcomplex *alpha, fcomplex *a, integer *lda, fcomplex *b, 
	integer *ldb, fcomplex *beta, fcomplex *c__, integer *ldc);

/* Subroutine */ int cgemv_(char *trans, integer *m, integer *n, fcomplex *
	alpha, fcomplex *a, integer *lda, fcomplex *x, integer *incx, fcomplex *
	beta, fcomplex *y, integer *incy);

/* Subroutine */ int cgerc_(integer *m, integer *n, fcomplex *alpha, fcomplex *
	x, integer *incx, fcomplex *y, integer *incy, fcomplex *a, integer *lda);

/* Subroutine */ int cgeru_(integer *m, integer *n, fcomplex *alpha, fcomplex *
	x, integer *incx, fcomplex *y, integer *incy, fcomplex *a, integer *lda);

/* Subroutine */ int chbmv_(char *uplo, integer *n, integer *k, fcomplex *
	alpha, fcomplex *a, integer *lda, fcomplex *x, integer *incx, fcomplex *
	beta, fcomplex *y, integer *incy);

/* Subroutine */ int chemm_(char *side, char *uplo, integer *m, integer *n, 
	fcomplex *alpha, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, 
	fcomplex *beta, fcomplex *c__, integer *ldc);

/* Subroutine */ int chemv_(char *uplo, integer *n, fcomplex *alpha, fcomplex *
	a, integer *lda, fcomplex *x, integer *incx, fcomplex *beta, fcomplex *y, 
	 integer *incy);

/* Subroutine */ int cher_(char *uplo, integer *n, real *alpha, fcomplex *x, 
	integer *incx, fcomplex *a, integer *lda);

/* Subroutine */ int cher2_(char *uplo, integer *n, fcomplex *alpha, fcomplex *
	x, integer *incx, fcomplex *y, integer *incy, fcomplex *a, integer *lda);

/* Subroutine */ int cher2k_(char *uplo, char *trans, integer *n, integer *k, 
	fcomplex *alpha, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, 
	real *beta, fcomplex *c__, integer *ldc);

/* Subroutine */ int cherk_(char *uplo, char *trans, integer *n, integer *k, 
	real *alpha, fcomplex *a, integer *lda, real *beta, fcomplex *c__, 
	integer *ldc);

/* Subroutine */ int chpmv_(char *uplo, integer *n, fcomplex *alpha, fcomplex *
	ap, fcomplex *x, integer *incx, fcomplex *beta, fcomplex *y, integer *
	incy);

/* Subroutine */ int chpr_(char *uplo, integer *n, real *alpha, fcomplex *x, 
	integer *incx, fcomplex *ap);

/* Subroutine */ int chpr2_(char *uplo, integer *n, fcomplex *alpha, fcomplex *
	x, integer *incx, fcomplex *y, integer *incy, fcomplex *ap);

/* Subroutine */ int crotg_(fcomplex *ca, fcomplex *cb, real *c__, fcomplex *s);

/* Subroutine */ int cscal_(integer *n, fcomplex *ca, fcomplex *cx, integer *
	incx);

/* Subroutine */ int csrot_(integer *n, fcomplex *cx, integer *incx, fcomplex *
	cy, integer *incy, real *c__, real *s);

/* Subroutine */ int csscal_(integer *n, real *sa, fcomplex *cx, integer *incx);

/* Subroutine */ int cswap_(integer *n, fcomplex *cx, integer *incx, fcomplex *
	cy, integer *incy);
...
/* Subroutine */ int csyrk_(char *uplo, char *trans, integer *n, integer *k, 
	fcomplex *alpha, fcomplex *a, integer *lda, fcomplex *beta, fcomplex *c__, 
	 integer *ldc);

/* Subroutine */ int ctbmv_(char *uplo, char *trans, char *diag, integer *n, 
	integer *k, fcomplex *a, integer *lda, fcomplex *x, integer *incx);
...
/* Subroutine */ int ctpmv_(char *uplo, char *trans, char *diag, integer *n, 
	fcomplex *ap, fcomplex *x, integer *incx);
...
/* Subroutine */ int ctrmm_(char *side, char *uplo, char *transa, char *diag, 
	integer *m, integer *n, fcomplex *alpha, fcomplex *a, integer *lda, 
	fcomplex *b, integer *ldb);

/* Subroutine */ int ctrmv_(char *uplo, char *trans, char *diag, integer *n, 
	fcomplex *a, integer *lda, fcomplex *x, integer *incx);
...
integer icamax_(integer *n, fcomplex *cx, integer *incx);
...
doublereal scabs1_(fcomplex *z__);

doublereal scasum_(integer *n, fcomplex *cx, integer *incx);

doublereal scnrm2_(integer *n, fcomplex *x, integer *incx);
...
/* Double fcomplex */ VOID zdotc_(doublecomplex * ret_val, integer *n, 
	doublecomplex *zx, integer *incx, doublecomplex *zy, integer *incy);

/* Double fcomplex */ VOID zdotu_(doublecomplex * ret_val, integer *n, 
	doublecomplex *zx, integer *incx, doublecomplex *zy, integer *incy);
...
/* Subroutine */ int cbdsqr_(char *uplo, integer *n, integer *ncvt, integer *
	nru, integer *ncc, real *d__, real *e, fcomplex *vt, integer *ldvt, 
	fcomplex *u, integer *ldu, fcomplex *c__, integer *ldc, real *rwork, 
	integer *info);

/* Subroutine */ int cgbbrd_(char *vect, integer *m, integer *n, integer *ncc, 
	 integer *kl, integer *ku, fcomplex *ab, integer *ldab, real *d__, 
	real *e, fcomplex *q, integer *ldq, fcomplex *pt, integer *ldpt, 
	fcomplex *c__, integer *ldc, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgbcon_(char *norm, integer *n, integer *kl, integer *ku, 
	 fcomplex *ab, integer *ldab, integer *ipiv, real *anorm, real *rcond, 
	fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgbequ_(integer *m, integer *n, integer *kl, integer *ku, 
	 fcomplex *ab, integer *ldab, real *r__, real *c__, real *rowcnd, real 
	*colcnd, real *amax, integer *info);

/* Subroutine */ int cgbequb_(integer *m, integer *n, integer *kl, integer *
	ku, fcomplex *ab, integer *ldab, real *r__, real *c__, real *rowcnd, 
	real *colcnd, real *amax, integer *info);

/* Subroutine */ int cgbrfs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, fcomplex *ab, integer *ldab, fcomplex *afb, integer *
	ldafb, integer *ipiv, fcomplex *b, integer *ldb, fcomplex *x, integer *
	ldx, real *ferr, real *berr, fcomplex *work, real *rwork, integer *
	info);

/* Subroutine */ int cgbrfsx_(char *trans, char *equed, integer *n, integer *
	kl, integer *ku, integer *nrhs, fcomplex *ab, integer *ldab, fcomplex *
	afb, integer *ldafb, integer *ipiv, real *r__, real *c__, fcomplex *b, 
	integer *ldb, fcomplex *x, integer *ldx, real *rcond, real *berr, 
	integer *n_err_bnds__, real *err_bnds_norm__, real *err_bnds_comp__, 
	integer *nparams, real *params, fcomplex *work, real *rwork, integer *
	info);

/* Subroutine */ int cgbsv_(integer *n, integer *kl, integer *ku, integer *
	nrhs, fcomplex *ab, integer *ldab, integer *ipiv, fcomplex *b, integer *
	ldb, integer *info);

/* Subroutine */ int cgbsvx_(char *fact, char *trans, integer *n, integer *kl, 
	 integer *ku, integer *nrhs, fcomplex *ab, integer *ldab, fcomplex *afb, 
	 integer *ldafb, integer *ipiv, char *equed, real *r__, real *c__, 
	fcomplex *b, integer *ldb, fcomplex *x, integer *ldx, real *rcond, real 
	*ferr, real *berr, fcomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int cgbtrs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, fcomplex *ab, integer *ldab, integer *ipiv, fcomplex 
	*b, integer *ldb, integer *info);

/* Subroutine */ int cgebak_(char *job, char *side, integer *n, integer *ilo, 
	integer *ihi, real *scale, integer *m, fcomplex *v, integer *ldv, 
	integer *info);

/* Subroutine */ int cgebal_(char *job, integer *n, fcomplex *a, integer *lda, 
	integer *ilo, integer *ihi, real *scale, integer *info);

/* Subroutine */ int cgebd2_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 real *d__, real *e, fcomplex *tauq, fcomplex *taup, fcomplex *work, 
	integer *info);

/* Subroutine */ int cgebrd_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 real *d__, real *e, fcomplex *tauq, fcomplex *taup, fcomplex *work, 
	integer *lwork, integer *info);

/* Subroutine */ int cgecon_(char *norm, integer *n, fcomplex *a, integer *lda, 
	 real *anorm, real *rcond, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgeequ_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 real *r__, real *c__, real *rowcnd, real *colcnd, real *amax, 
	integer *info);

/* Subroutine */ int cgeequb_(integer *m, integer *n, fcomplex *a, integer *
	lda, real *r__, real *c__, real *rowcnd, real *colcnd, real *amax, 
	integer *info);

/* Subroutine */ int cgees_(char *jobvs, char *sort, L_fp select, integer *n, 
	fcomplex *a, integer *lda, integer *sdim, fcomplex *w, fcomplex *vs, 
	integer *ldvs, fcomplex *work, integer *lwork, real *rwork, logical *
	bwork, integer *info);

/* Subroutine */ int cgeesx_(char *jobvs, char *sort, L_fp select, char *
	sense, integer *n, fcomplex *a, integer *lda, integer *sdim, fcomplex *
	w, fcomplex *vs, integer *ldvs, real *rconde, real *rcondv, fcomplex *
	work, integer *lwork, real *rwork, logical *bwork, integer *info);

/* Subroutine */ int cgeev_(char *jobvl, char *jobvr, integer *n, fcomplex *a, 
	integer *lda, fcomplex *w, fcomplex *vl, integer *ldvl, fcomplex *vr, 
	integer *ldvr, fcomplex *work, integer *lwork, real *rwork, integer *
	info);

/* Subroutine */ int cgeevx_(char *balanc, char *jobvl, char *jobvr, char *
	sense, integer *n, fcomplex *a, integer *lda, fcomplex *w, fcomplex *vl, 
	integer *ldvl, fcomplex *vr, integer *ldvr, integer *ilo, integer *ihi, 
	 real *scale, real *abnrm, real *rconde, real *rcondv, fcomplex *work, 
	integer *lwork, real *rwork, integer *info);

/* Subroutine */ int cgegs_(char *jobvsl, char *jobvsr, integer *n, fcomplex *
	a, integer *lda, fcomplex *b, integer *ldb, fcomplex *alpha, fcomplex *
	beta, fcomplex *vsl, integer *ldvsl, fcomplex *vsr, integer *ldvsr, 
	fcomplex *work, integer *lwork, real *rwork, integer *info);

/* Subroutine */ int cgegv_(char *jobvl, char *jobvr, integer *n, fcomplex *a, 
	integer *lda, fcomplex *b, integer *ldb, fcomplex *alpha, fcomplex *beta, 
	 fcomplex *vl, integer *ldvl, fcomplex *vr, integer *ldvr, fcomplex *
	work, integer *lwork, real *rwork, integer *info);

/* Subroutine */ int cgehd2_(integer *n, integer *ilo, integer *ihi, fcomplex *
	a, integer *lda, fcomplex *tau, fcomplex *work, integer *info);

/* Subroutine */ int cgehrd_(integer *n, integer *ilo, integer *ihi, fcomplex *
	a, integer *lda, fcomplex *tau, fcomplex *work, integer *lwork, integer 
	*info);

/* Subroutine */ int cgelq2_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, fcomplex *work, integer *info);

/* Subroutine */ int cgelqf_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cgels_(char *trans, integer *m, integer *n, integer *
	nrhs, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, fcomplex *
	work, integer *lwork, integer *info);

/* Subroutine */ int cgelsd_(integer *m, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, fcomplex *b, integer *ldb, real *s, real *rcond, 
	integer *rank, fcomplex *work, integer *lwork, real *rwork, integer *
	iwork, integer *info);

/* Subroutine */ int cgelss_(integer *m, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, fcomplex *b, integer *ldb, real *s, real *rcond, 
	integer *rank, fcomplex *work, integer *lwork, real *rwork, integer *
	info);

/* Subroutine */ int cgelsx_(integer *m, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, fcomplex *b, integer *ldb, integer *jpvt, real *rcond, 
	 integer *rank, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgelsy_(integer *m, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, fcomplex *b, integer *ldb, integer *jpvt, real *rcond, 
	 integer *rank, fcomplex *work, integer *lwork, real *rwork, integer *
	info);

/* Subroutine */ int cgeql2_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, fcomplex *work, integer *info);

/* Subroutine */ int cgeqlf_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cgeqp3_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 integer *jpvt, fcomplex *tau, fcomplex *work, integer *lwork, real *
	rwork, integer *info);

/* Subroutine */ int cgeqpf_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 integer *jpvt, fcomplex *tau, fcomplex *work, real *rwork, integer *
	info);

/* Subroutine */ int cgeqr2_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, fcomplex *work, integer *info);

/* Subroutine */ int cgeqrf_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cgerfs_(char *trans, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, fcomplex *af, integer *ldaf, integer *ipiv, fcomplex *
	b, integer *ldb, fcomplex *x, integer *ldx, real *ferr, real *berr, 
	fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgerfsx_(char *trans, char *equed, integer *n, integer *
	nrhs, fcomplex *a, integer *lda, fcomplex *af, integer *ldaf, integer *
	ipiv, real *r__, real *c__, fcomplex *b, integer *ldb, fcomplex *x, 
	integer *ldx, real *rcond, real *berr, integer *n_err_bnds__, real *
	err_bnds_norm__, real *err_bnds_comp__, integer *nparams, real *
	params, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgerq2_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, fcomplex *work, integer *info);

/* Subroutine */ int cgerqf_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cgesc2_(integer *n, fcomplex *a, integer *lda, fcomplex *
	rhs, integer *ipiv, integer *jpiv, real *scale);

/* Subroutine */ int cgesdd_(char *jobz, integer *m, integer *n, fcomplex *a, 
	integer *lda, real *s, fcomplex *u, integer *ldu, fcomplex *vt, integer 
	*ldvt, fcomplex *work, integer *lwork, real *rwork, integer *iwork, 
	integer *info);

/* Subroutine */ int cgesv_(integer *n, integer *nrhs, fcomplex *a, integer *
	lda, integer *ipiv, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cgesvd_(char *jobu, char *jobvt, integer *m, integer *n, 
	fcomplex *a, integer *lda, real *s, fcomplex *u, integer *ldu, fcomplex *
	vt, integer *ldvt, fcomplex *work, integer *lwork, real *rwork, 
	integer *info);

/* Subroutine */ int cgesvx_(char *fact, char *trans, integer *n, integer *
	nrhs, fcomplex *a, integer *lda, fcomplex *af, integer *ldaf, integer *
	ipiv, char *equed, real *r__, real *c__, fcomplex *b, integer *ldb, 
	fcomplex *x, integer *ldx, real *rcond, real *ferr, real *berr, 
	fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgesvxx_(char *fact, char *trans, integer *n, integer *
	nrhs, fcomplex *a, integer *lda, fcomplex *af, integer *ldaf, integer *
	ipiv, char *equed, real *r__, real *c__, fcomplex *b, integer *ldb, 
	fcomplex *x, integer *ldx, real *rcond, real *rpvgrw, real *berr, 
	integer *n_err_bnds__, real *err_bnds_norm__, real *err_bnds_comp__, 
	integer *nparams, real *params, fcomplex *work, real *rwork, integer *
	info);

/* Subroutine */ int cgetc2_(integer *n, fcomplex *a, integer *lda, integer *
	ipiv, integer *jpiv, integer *info);

/* Subroutine */ int cgetf2_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 integer *ipiv, integer *info);

/* Subroutine */ int cgetrf_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 integer *ipiv, integer *info);

/* Subroutine */ int cgetri_(integer *n, fcomplex *a, integer *lda, integer *
	ipiv, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cgetrs_(char *trans, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, integer *ipiv, fcomplex *b, integer *ldb, integer *
	info);

/* Subroutine */ int cggbak_(char *job, char *side, integer *n, integer *ilo, 
	integer *ihi, real *lscale, real *rscale, integer *m, fcomplex *v, 
	integer *ldv, integer *info);

/* Subroutine */ int cggbal_(char *job, integer *n, fcomplex *a, integer *lda, 
	fcomplex *b, integer *ldb, integer *ilo, integer *ihi, real *lscale, 
	real *rscale, real *work, integer *info);

/* Subroutine */ int cgges_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	selctg, integer *n, fcomplex *a, integer *lda, fcomplex *b, integer *
	ldb, integer *sdim, fcomplex *alpha, fcomplex *beta, fcomplex *vsl, 
	integer *ldvsl, fcomplex *vsr, integer *ldvsr, fcomplex *work, integer *
	lwork, real *rwork, logical *bwork, integer *info);

/* Subroutine */ int cggesx_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	selctg, char *sense, integer *n, fcomplex *a, integer *lda, fcomplex *b, 
	 integer *ldb, integer *sdim, fcomplex *alpha, fcomplex *beta, fcomplex *
	vsl, integer *ldvsl, fcomplex *vsr, integer *ldvsr, real *rconde, real 
	*rcondv, fcomplex *work, integer *lwork, real *rwork, integer *iwork, 
	integer *liwork, logical *bwork, integer *info);

/* Subroutine */ int cggev_(char *jobvl, char *jobvr, integer *n, fcomplex *a, 
	integer *lda, fcomplex *b, integer *ldb, fcomplex *alpha, fcomplex *beta, 
	 fcomplex *vl, integer *ldvl, fcomplex *vr, integer *ldvr, fcomplex *
	work, integer *lwork, real *rwork, integer *info);

/* Subroutine */ int cggevx_(char *balanc, char *jobvl, char *jobvr, char *
	sense, integer *n, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, 
	 fcomplex *alpha, fcomplex *beta, fcomplex *vl, integer *ldvl, fcomplex *
	vr, integer *ldvr, integer *ilo, integer *ihi, real *lscale, real *
	rscale, real *abnrm, real *bbnrm, real *rconde, real *rcondv, fcomplex 
	*work, integer *lwork, real *rwork, integer *iwork, logical *bwork, 
	integer *info);

/* Subroutine */ int cggglm_(integer *n, integer *m, integer *p, fcomplex *a, 
	integer *lda, fcomplex *b, integer *ldb, fcomplex *d__, fcomplex *x, 
	fcomplex *y, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cgghrd_(char *compq, char *compz, integer *n, integer *
	ilo, integer *ihi, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, 
	 fcomplex *q, integer *ldq, fcomplex *z__, integer *ldz, integer *info);

/* Subroutine */ int cgglse_(integer *m, integer *n, integer *p, fcomplex *a, 
	integer *lda, fcomplex *b, integer *ldb, fcomplex *c__, fcomplex *d__, 
	fcomplex *x, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cggqrf_(integer *n, integer *m, integer *p, fcomplex *a, 
	integer *lda, fcomplex *taua, fcomplex *b, integer *ldb, fcomplex *taub, 
	fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cggrqf_(integer *m, integer *p, integer *n, fcomplex *a, 
	integer *lda, fcomplex *taua, fcomplex *b, integer *ldb, fcomplex *taub, 
	fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cggsvd_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *n, integer *p, integer *k, integer *l, fcomplex *a, integer *
	lda, fcomplex *b, integer *ldb, real *alpha, real *beta, fcomplex *u, 
	integer *ldu, fcomplex *v, integer *ldv, fcomplex *q, integer *ldq, 
	fcomplex *work, real *rwork, integer *iwork, integer *info);

/* Subroutine */ int cggsvp_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *p, integer *n, fcomplex *a, integer *lda, fcomplex *b, integer 
	*ldb, real *tola, real *tolb, integer *k, integer *l, fcomplex *u, 
	integer *ldu, fcomplex *v, integer *ldv, fcomplex *q, integer *ldq, 
	integer *iwork, real *rwork, fcomplex *tau, fcomplex *work, integer *
	info);

/* Subroutine */ int cgtcon_(char *norm, integer *n, fcomplex *dl, fcomplex *
	d__, fcomplex *du, fcomplex *du2, integer *ipiv, real *anorm, real *
	rcond, fcomplex *work, integer *info);

/* Subroutine */ int cgtrfs_(char *trans, integer *n, integer *nrhs, fcomplex *
	dl, fcomplex *d__, fcomplex *du, fcomplex *dlf, fcomplex *df, fcomplex *
	duf, fcomplex *du2, integer *ipiv, fcomplex *b, integer *ldb, fcomplex *
	x, integer *ldx, real *ferr, real *berr, fcomplex *work, real *rwork, 
	integer *info);

/* Subroutine */ int cgtsv_(integer *n, integer *nrhs, fcomplex *dl, fcomplex *
	d__, fcomplex *du, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cgtsvx_(char *fact, char *trans, integer *n, integer *
	nrhs, fcomplex *dl, fcomplex *d__, fcomplex *du, fcomplex *dlf, fcomplex *
	df, fcomplex *duf, fcomplex *du2, integer *ipiv, fcomplex *b, integer *
	ldb, fcomplex *x, integer *ldx, real *rcond, real *ferr, real *berr, 
	fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cgttrf_(integer *n, fcomplex *dl, fcomplex *d__, fcomplex *
	du, fcomplex *du2, integer *ipiv, integer *info);

/* Subroutine */ int cgttrs_(char *trans, integer *n, integer *nrhs, fcomplex *
	dl, fcomplex *d__, fcomplex *du, fcomplex *du2, integer *ipiv, fcomplex *
	b, integer *ldb, integer *info);

/* Subroutine */ int cgtts2_(integer *itrans, integer *n, integer *nrhs, 
	fcomplex *dl, fcomplex *d__, fcomplex *du, fcomplex *du2, integer *ipiv, 
	fcomplex *b, integer *ldb);

/* Subroutine */ int chbev_(char *jobz, char *uplo, integer *n, integer *kd, 
	fcomplex *ab, integer *ldab, real *w, fcomplex *z__, integer *ldz, 
	fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int chbevd_(char *jobz, char *uplo, integer *n, integer *kd, 
	fcomplex *ab, integer *ldab, real *w, fcomplex *z__, integer *ldz, 
	fcomplex *work, integer *lwork, real *rwork, integer *lrwork, integer *
	iwork, integer *liwork, integer *info);

/* Subroutine */ int chbevx_(char *jobz, char *range, char *uplo, integer *n, 
	integer *kd, fcomplex *ab, integer *ldab, fcomplex *q, integer *ldq, 
	real *vl, real *vu, integer *il, integer *iu, real *abstol, integer *
	m, real *w, fcomplex *z__, integer *ldz, fcomplex *work, real *rwork, 
	integer *iwork, integer *ifail, integer *info);

/* Subroutine */ int chbgst_(char *vect, char *uplo, integer *n, integer *ka, 
	integer *kb, fcomplex *ab, integer *ldab, fcomplex *bb, integer *ldbb, 
	fcomplex *x, integer *ldx, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int chbgv_(char *jobz, char *uplo, integer *n, integer *ka, 
	integer *kb, fcomplex *ab, integer *ldab, fcomplex *bb, integer *ldbb, 
	real *w, fcomplex *z__, integer *ldz, fcomplex *work, real *rwork, 
	integer *info);

/* Subroutine */ int chbgvd_(char *jobz, char *uplo, integer *n, integer *ka, 
	integer *kb, fcomplex *ab, integer *ldab, fcomplex *bb, integer *ldbb, 
	real *w, fcomplex *z__, integer *ldz, fcomplex *work, integer *lwork, 
	real *rwork, integer *lrwork, integer *iwork, integer *liwork, 
	integer *info);

/* Subroutine */ int chbgvx_(char *jobz, char *range, char *uplo, integer *n, 
	integer *ka, integer *kb, fcomplex *ab, integer *ldab, fcomplex *bb, 
	integer *ldbb, fcomplex *q, integer *ldq, real *vl, real *vu, integer *
	il, integer *iu, real *abstol, integer *m, real *w, fcomplex *z__, 
	integer *ldz, fcomplex *work, real *rwork, integer *iwork, integer *
	ifail, integer *info);

/* Subroutine */ int chbtrd_(char *vect, char *uplo, integer *n, integer *kd, 
	fcomplex *ab, integer *ldab, real *d__, real *e, fcomplex *q, integer *
	ldq, fcomplex *work, integer *info);

/* Subroutine */ int checon_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *ipiv, real *anorm, real *rcond, fcomplex *work, integer *
	info);

/* Subroutine */ int cheequb_(char *uplo, integer *n, fcomplex *a, integer *
	lda, real *s, real *scond, real *amax, fcomplex *work, integer *info);

/* Subroutine */ int cheev_(char *jobz, char *uplo, integer *n, fcomplex *a, 
	integer *lda, real *w, fcomplex *work, integer *lwork, real *rwork, 
	integer *info);

/* Subroutine */ int cheevd_(char *jobz, char *uplo, integer *n, fcomplex *a, 
	integer *lda, real *w, fcomplex *work, integer *lwork, real *rwork, 
	integer *lrwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int cheevr_(char *jobz, char *range, char *uplo, integer *n, 
	fcomplex *a, integer *lda, real *vl, real *vu, integer *il, integer *
	iu, real *abstol, integer *m, real *w, fcomplex *z__, integer *ldz, 
	integer *isuppz, fcomplex *work, integer *lwork, real *rwork, integer *
	lrwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int cheevx_(char *jobz, char *range, char *uplo, integer *n, 
	fcomplex *a, integer *lda, real *vl, real *vu, integer *il, integer *
	iu, real *abstol, integer *m, real *w, fcomplex *z__, integer *ldz, 
	fcomplex *work, integer *lwork, real *rwork, integer *iwork, integer *
	ifail, integer *info);

/* Subroutine */ int chegs2_(integer *itype, char *uplo, integer *n, fcomplex *
	a, integer *lda, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int chegst_(integer *itype, char *uplo, integer *n, fcomplex *
	a, integer *lda, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int chegv_(integer *itype, char *jobz, char *uplo, integer *
	n, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, real *w, 
	fcomplex *work, integer *lwork, real *rwork, integer *info);
...
/* Subroutine */ int chegvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, 
	real *vl, real *vu, integer *il, integer *iu, real *abstol, integer *
	m, real *w, fcomplex *z__, integer *ldz, fcomplex *work, integer *lwork, 
	 real *rwork, integer *iwork, integer *ifail, integer *info);

/* Subroutine */ int cherfs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, fcomplex *af, integer *ldaf, integer *ipiv, fcomplex *
	b, integer *ldb, fcomplex *x, integer *ldx, real *ferr, real *berr, 
	fcomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int cherfsx_(char *uplo, char *equed, integer *n, integer *
	nrhs, fcomplex *a, integer *lda, fcomplex *af, integer *ldaf, integer *
	ipiv, real *s, fcomplex *b, integer *ldb, fcomplex *x, integer *ldx, 
	real *rcond, real *berr, integer *n_err_bnds__, real *err_bnds_norm__, 
	 real *err_bnds_comp__, integer *nparams, real *params, fcomplex *work, 
	 real *rwork, integer *info);

/* Subroutine */ int chesv_(char *uplo, integer *n, integer *nrhs, fcomplex *a, 
	 integer *lda, integer *ipiv, fcomplex *b, integer *ldb, fcomplex *work, 
	 integer *lwork, integer *info);

/* Subroutine */ int chesvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, fcomplex *a, integer *lda, fcomplex *af, integer *ldaf, integer *
	ipiv, fcomplex *b, integer *ldb, fcomplex *x, integer *ldx, real *rcond, 
	 real *ferr, real *berr, fcomplex *work, integer *lwork, real *rwork, 
	integer *info);

/* Subroutine */ int chesvxx_(char *fact, char *uplo, integer *n, integer *
	nrhs, fcomplex *a, integer *lda, fcomplex *af, integer *ldaf, integer *
	ipiv, char *equed, real *s, fcomplex *b, integer *ldb, fcomplex *x, 
	integer *ldx, real *rcond, real *rpvgrw, real *berr, integer *
	n_err_bnds__, real *err_bnds_norm__, real *err_bnds_comp__, integer *
	nparams, real *params, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int chetd2_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 real *d__, real *e, fcomplex *tau, integer *info);

/* Subroutine */ int chetf2_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *ipiv, integer *info);

/* Subroutine */ int chetrd_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 real *d__, real *e, fcomplex *tau, fcomplex *work, integer *lwork, 
	integer *info);

/* Subroutine */ int chetrf_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *ipiv, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int chetri_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *ipiv, fcomplex *work, integer *info);

/* Subroutine */ int chetrs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, integer *ipiv, fcomplex *b, integer *ldb, integer *
	info);

/* Subroutine */ int chfrk_(char *transr, char *uplo, char *trans, integer *n, 
	 integer *k, real *alpha, fcomplex *a, integer *lda, real *beta, 
	fcomplex *c__);

/* Subroutine */ int chgeqz_(char *job, char *compq, char *compz, integer *n, 
	integer *ilo, integer *ihi, fcomplex *h__, integer *ldh, fcomplex *t, 
	integer *ldt, fcomplex *alpha, fcomplex *beta, fcomplex *q, integer *ldq, 
	 fcomplex *z__, integer *ldz, fcomplex *work, integer *lwork, real *
	rwork, integer *info);

/* Character */ VOID chla_transtype__(char *ret_val, ftnlen ret_val_len, 
	integer *trans);

/* Subroutine */ int chpcon_(char *uplo, integer *n, fcomplex *ap, integer *
	ipiv, real *anorm, real *rcond, fcomplex *work, integer *info);

/* Subroutine */ int chpev_(char *jobz, char *uplo, integer *n, fcomplex *ap, 
	real *w, fcomplex *z__, integer *ldz, fcomplex *work, real *rwork, 
	integer *info);

/* Subroutine */ int chpevd_(char *jobz, char *uplo, integer *n, fcomplex *ap, 
	real *w, fcomplex *z__, integer *ldz, fcomplex *work, integer *lwork, 
	real *rwork, integer *lrwork, integer *iwork, integer *liwork, 
	integer *info);

/* Subroutine */ int chpevx_(char *jobz, char *range, char *uplo, integer *n, 
	fcomplex *ap, real *vl, real *vu, integer *il, integer *iu, real *
	abstol, integer *m, real *w, fcomplex *z__, integer *ldz, fcomplex *
	work, real *rwork, integer *iwork, integer *ifail, integer *info);

/* Subroutine */ int chpgst_(integer *itype, char *uplo, integer *n, fcomplex *
	ap, fcomplex *bp, integer *info);

/* Subroutine */ int chpgv_(integer *itype, char *jobz, char *uplo, integer *
	n, fcomplex *ap, fcomplex *bp, real *w, fcomplex *z__, integer *ldz, 
	fcomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int chpgvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, fcomplex *ap, fcomplex *bp, real *vl, real *vu, 
	integer *il, integer *iu, real *abstol, integer *m, real *w, fcomplex *
	z__, integer *ldz, fcomplex *work, real *rwork, integer *iwork, 
	integer *ifail, integer *info);

/* Subroutine */ int chprfs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	ap, fcomplex *afp, integer *ipiv, fcomplex *b, integer *ldb, fcomplex *x, 
	 integer *ldx, real *ferr, real *berr, fcomplex *work, real *rwork, 
	integer *info);

/* Subroutine */ int chpsv_(char *uplo, integer *n, integer *nrhs, fcomplex *
	ap, integer *ipiv, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int chpsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, fcomplex *ap, fcomplex *afp, integer *ipiv, fcomplex *b, integer *
	ldb, fcomplex *x, integer *ldx, real *rcond, real *ferr, real *berr, 
	fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int chptrd_(char *uplo, integer *n, fcomplex *ap, real *d__, 
	real *e, fcomplex *tau, integer *info);

/* Subroutine */ int chptrf_(char *uplo, integer *n, fcomplex *ap, integer *
	ipiv, integer *info);

/* Subroutine */ int chptri_(char *uplo, integer *n, fcomplex *ap, integer *
	ipiv, fcomplex *work, integer *info);

/* Subroutine */ int chptrs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	ap, integer *ipiv, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int chsein_(char *side, char *eigsrc, char *initv, logical *
	select, integer *n, fcomplex *h__, integer *ldh, fcomplex *w, fcomplex *
	vl, integer *ldvl, fcomplex *vr, integer *ldvr, integer *mm, integer *
	m, fcomplex *work, real *rwork, integer *ifaill, integer *ifailr, 
	integer *info);

/* Subroutine */ int chseqr_(char *job, char *compz, integer *n, integer *ilo, 
	 integer *ihi, fcomplex *h__, integer *ldh, fcomplex *w, fcomplex *z__, 
	integer *ldz, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cla_gbamv__(integer *trans, integer *m, integer *n, 
	integer *kl, integer *ku, real *alpha, fcomplex *ab, integer *ldab, 
	fcomplex *x, integer *incx, real *beta, real *y, integer *incy);

doublereal cla_gbrcond_c__(char *trans, integer *n, integer *kl, integer *ku, 
	fcomplex *ab, integer *ldab, fcomplex *afb, integer *ldafb, integer *
	ipiv, real *c__, logical *capply, integer *info, fcomplex *work, real *
	rwork, ftnlen trans_len);

doublereal cla_gbrcond_x__(char *trans, integer *n, integer *kl, integer *ku, 
	fcomplex *ab, integer *ldab, fcomplex *afb, integer *ldafb, integer *
	ipiv, fcomplex *x, integer *info, fcomplex *work, real *rwork, ftnlen 
	trans_len);
...
/* Subroutine */ int cla_gbrfsx_extended__(integer *prec_type__, integer *
	...
	fcomplex *ab, integer *ldab, fcomplex *afb, integer *ldafb, integer *
	ipiv, logical *colequ, real *c__, fcomplex *b, integer *ldb, fcomplex *
	y, integer *ldy, real *berr_out__, integer *n_norms__, real *errs_n__,
	 real *errs_c__, fcomplex *res, real *ayb, fcomplex *dy, fcomplex *
...
doublereal cla_gbrpvgrw__(integer *n, integer *kl, integer *ku, integer *
	ncols, fcomplex *ab, integer *ldab, fcomplex *afb, integer *ldafb);

/* Subroutine */ int cla_geamv__(integer *trans, integer *m, integer *n, real 
	*alpha, fcomplex *a, integer *lda, fcomplex *x, integer *incx, real *
	beta, real *y, integer *incy);

doublereal cla_gercond_c__(char *trans, integer *n, fcomplex *a, integer *lda, 
	fcomplex *af, integer *ldaf, integer *ipiv, real *c__, logical *capply,
	 integer *info, fcomplex *work, real *rwork, ftnlen trans_len);

doublereal cla_gercond_x__(char *trans, integer *n, fcomplex *a, integer *lda, 
	fcomplex *af, integer *ldaf, integer *ipiv, fcomplex *x, integer *info, 
	fcomplex *work, real *rwork, ftnlen trans_len);

/* Subroutine */ int cla_gerfsx_extended__(integer *prec_type__, integer *
	trans_type__, integer *n, integer *nrhs, fcomplex *a, integer *lda, 
	fcomplex *af, integer *ldaf, integer *ipiv, logical *colequ, real *c__,
	 fcomplex *b, integer *ldb, fcomplex *y, integer *ldy, real *berr_out__,
	 integer *n_norms__, real *errs_n__, real *errs_c__, fcomplex *res, 
	real *ayb, fcomplex *dy, fcomplex *y_tail__, real *rcond, integer *
	ithresh, real *rthresh, real *dz_ub__, logical *ignore_cwise__, 
	integer *info);

/* Subroutine */ int cla_heamv__(integer *uplo, integer *n, real *alpha, 
	fcomplex *a, integer *lda, fcomplex *x, integer *incx, real *beta, real 
	*y, integer *incy);

doublereal cla_hercond_c__(char *uplo, integer *n, fcomplex *a, integer *lda, 
	fcomplex *af, integer *ldaf, integer *ipiv, real *c__, logical *capply,
	 integer *info, fcomplex *work, real *rwork, ftnlen uplo_len);

doublereal cla_hercond_x__(char *uplo, integer *n, fcomplex *a, integer *lda, 
	fcomplex *af, integer *ldaf, integer *ipiv, fcomplex *x, integer *info, 
	fcomplex *work, real *rwork, ftnlen uplo_len);

/* Subroutine */ int cla_herfsx_extended__(integer *prec_type__, char *uplo, 
	integer *n, integer *nrhs, fcomplex *a, integer *lda, fcomplex *af, 
	integer *ldaf, integer *ipiv, logical *colequ, real *c__, fcomplex *b, 
	integer *ldb, fcomplex *y, integer *ldy, real *berr_out__, integer *
	n_norms__, real *errs_n__, real *errs_c__, fcomplex *res, real *ayb, 
	fcomplex *dy, fcomplex *y_tail__, real *rcond, integer *ithresh, real *
	rthresh, real *dz_ub__, logical *ignore_cwise__, integer *info, 
	ftnlen uplo_len);

doublereal cla_herpvgrw__(char *uplo, integer *n, integer *info, fcomplex *a, 
	integer *lda, fcomplex *af, integer *ldaf, integer *ipiv, real *work, 
	ftnlen uplo_len);

/* Subroutine */ int cla_lin_berr__(integer *n, integer *nz, integer *nrhs, 
	fcomplex *res, real *ayb, real *berr);

doublereal cla_porcond_c__(char *uplo, integer *n, fcomplex *a, integer *lda, 
	fcomplex *af, integer *ldaf, real *c__, logical *capply, integer *info,
	 fcomplex *work, real *rwork, ftnlen uplo_len);

doublereal cla_porcond_x__(char *uplo, integer *n, fcomplex *a, integer *lda, 
	fcomplex *af, integer *ldaf, fcomplex *x, integer *info, fcomplex *work, 
	real *rwork, ftnlen uplo_len);

/* Subroutine */ int cla_porfsx_extended__(integer *prec_type__, char *uplo, 
	integer *n, integer *nrhs, fcomplex *a, integer *lda, fcomplex *af, 
	integer *ldaf, logical *colequ, real *c__, fcomplex *b, integer *ldb, 
	fcomplex *y, integer *ldy, real *berr_out__, integer *n_norms__, real *
	errs_n__, real *errs_c__, fcomplex *res, real *ayb, fcomplex *dy, 
	fcomplex *y_tail__, real *rcond, integer *ithresh, real *rthresh, real 
	*dz_ub__, logical *ignore_cwise__, integer *info, ftnlen uplo_len);

doublereal cla_porpvgrw__(char *uplo, integer *ncols, fcomplex *a, integer *
	lda, fcomplex *af, integer *ldaf, real *work, ftnlen uplo_len);

doublereal cla_rpvgrw__(integer *n, integer *ncols, fcomplex *a, integer *lda, 
	fcomplex *af, integer *ldaf);

/* Subroutine */ int cla_syamv__(integer *uplo, integer *n, real *alpha, 
	fcomplex *a, integer *lda, fcomplex *x, integer *incx, real *beta, real 
	*y, integer *incy);

doublereal cla_syrcond_c__(char *uplo, integer *n, fcomplex *a, integer *lda, 
	fcomplex *af, integer *ldaf, integer *ipiv, real *c__, logical *capply,
	 integer *info, fcomplex *work, real *rwork, ftnlen uplo_len);

doublereal cla_syrcond_x__(char *uplo, integer *n, fcomplex *a, integer *lda, 
	fcomplex *af, integer *ldaf, integer *ipiv, fcomplex *x, integer *info, 
	fcomplex *work, real *rwork, ftnlen uplo_len);
...
doublereal cla_syrpvgrw__(char *uplo, integer *n, integer *info, fcomplex *a, 
	integer *lda, fcomplex *af, integer *ldaf, integer *ipiv, real *work, 
	ftnlen uplo_len);

/* Subroutine */ int cla_wwaddw__(integer *n, fcomplex *x, fcomplex *y, fcomplex 
	*w);

/* Subroutine */ int clabrd_(integer *m, integer *n, integer *nb, fcomplex *a, 
	integer *lda, real *d__, real *e, fcomplex *tauq, fcomplex *taup, 
	fcomplex *x, integer *ldx, fcomplex *y, integer *ldy);

/* Subroutine */ int clacgv_(integer *n, fcomplex *x, integer *incx);

/* Subroutine */ int clacn2_(integer *n, fcomplex *v, fcomplex *x, real *est, 
	integer *kase, integer *isave);

/* Subroutine */ int clacon_(integer *n, fcomplex *v, fcomplex *x, real *est, 
	integer *kase);

/* Subroutine */ int clacp2_(char *uplo, integer *m, integer *n, real *a, 
	integer *lda, fcomplex *b, integer *ldb);

/* Subroutine */ int clacpy_(char *uplo, integer *m, integer *n, fcomplex *a, 
	integer *lda, fcomplex *b, integer *ldb);

/* Subroutine */ int clacrm_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 real *b, integer *ldb, fcomplex *c__, integer *ldc, real *rwork);

/* Subroutine */ int clacrt_(integer *n, fcomplex *cx, integer *incx, fcomplex *
	cy, integer *incy, fcomplex *c__, fcomplex *s);

/* fcomplex */ VOID cladiv_(fcomplex * ret_val, fcomplex *x, fcomplex *y);

/* Subroutine */ int claed0_(integer *qsiz, integer *n, real *d__, real *e, 
	fcomplex *q, integer *ldq, fcomplex *qstore, integer *ldqs, real *rwork, 
	 integer *iwork, integer *info);

/* Subroutine */ int claed7_(integer *n, integer *cutpnt, integer *qsiz, 
	integer *tlvls, integer *curlvl, integer *curpbm, real *d__, fcomplex *
	q, integer *ldq, real *rho, integer *indxq, real *qstore, integer *
	qptr, integer *prmptr, integer *perm, integer *givptr, integer *
	givcol, real *givnum, fcomplex *work, real *rwork, integer *iwork, 
	integer *info);

/* Subroutine */ int claed8_(integer *k, integer *n, integer *qsiz, fcomplex *
	q, integer *ldq, real *d__, real *rho, integer *cutpnt, real *z__, 
	real *dlamda, fcomplex *q2, integer *ldq2, real *w, integer *indxp, 
...
/* Subroutine */ int claein_(logical *rightv, logical *noinit, integer *n, 
	fcomplex *h__, integer *ldh, fcomplex *w, fcomplex *v, fcomplex *b, 
	integer *ldb, real *rwork, real *eps3, real *smlnum, integer *info);

/* Subroutine */ int claesy_(fcomplex *a, fcomplex *b, fcomplex *c__, fcomplex *
	rt1, fcomplex *rt2, fcomplex *evscal, fcomplex *cs1, fcomplex *sn1);

/* Subroutine */ int claev2_(fcomplex *a, fcomplex *b, fcomplex *c__, real *rt1, 
	real *rt2, real *cs1, fcomplex *sn1);

/* Subroutine */ int clag2z_(integer *m, integer *n, fcomplex *sa, integer *
	ldsa, doublecomplex *a, integer *lda, integer *info);

/* Subroutine */ int clags2_(logical *upper, real *a1, fcomplex *a2, real *a3, 
	real *b1, fcomplex *b2, real *b3, real *csu, fcomplex *snu, real *csv, 
	fcomplex *snv, real *csq, fcomplex *snq);

/* Subroutine */ int clagtm_(char *trans, integer *n, integer *nrhs, real *
	alpha, fcomplex *dl, fcomplex *d__, fcomplex *du, fcomplex *x, integer *
	ldx, real *beta, fcomplex *b, integer *ldb);

/* Subroutine */ int clahef_(char *uplo, integer *n, integer *nb, integer *kb, 
	 fcomplex *a, integer *lda, integer *ipiv, fcomplex *w, integer *ldw, 
	integer *info);

/* Subroutine */ int clahqr_(logical *wantt, logical *wantz, integer *n, 
	integer *ilo, integer *ihi, fcomplex *h__, integer *ldh, fcomplex *w, 
	integer *iloz, integer *ihiz, fcomplex *z__, integer *ldz, integer *
	info);

/* Subroutine */ int clahr2_(integer *n, integer *k, integer *nb, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *t, integer *ldt, fcomplex *y, 
	integer *ldy);

/* Subroutine */ int clahrd_(integer *n, integer *k, integer *nb, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *t, integer *ldt, fcomplex *y, 
	integer *ldy);

/* Subroutine */ int claic1_(integer *job, integer *j, fcomplex *x, real *sest, 
	 fcomplex *w, fcomplex *gamma, real *sestpr, fcomplex *s, fcomplex *c__);

/* Subroutine */ int clals0_(integer *icompq, integer *nl, integer *nr, 
	integer *sqre, integer *nrhs, fcomplex *b, integer *ldb, fcomplex *bx, 
...
/* Subroutine */ int clalsa_(integer *icompq, integer *smlsiz, integer *n, 
	integer *nrhs, fcomplex *b, integer *ldb, fcomplex *bx, integer *ldbx, 
...
/* Subroutine */ int clalsd_(char *uplo, integer *smlsiz, integer *n, integer 
	*nrhs, real *d__, real *e, fcomplex *b, integer *ldb, real *rcond, 
	integer *rank, fcomplex *work, real *rwork, integer *iwork, integer *
	info);

doublereal clangb_(char *norm, integer *n, integer *kl, integer *ku, fcomplex *
	ab, integer *ldab, real *work);

doublereal clange_(char *norm, integer *m, integer *n, fcomplex *a, integer *
	lda, real *work);

doublereal clangt_(char *norm, integer *n, fcomplex *dl, fcomplex *d__, fcomplex 
	*du);

doublereal clanhb_(char *norm, char *uplo, integer *n, integer *k, fcomplex *
	ab, integer *ldab, real *work);

doublereal clanhe_(char *norm, char *uplo, integer *n, fcomplex *a, integer *
	lda, real *work);

doublereal clanhf_(char *norm, char *transr, char *uplo, integer *n, fcomplex *
	a, real *work);

doublereal clanhp_(char *norm, char *uplo, integer *n, fcomplex *ap, real *
	work);

doublereal clanhs_(char *norm, integer *n, fcomplex *a, integer *lda, real *
	work);

doublereal clanht_(char *norm, integer *n, real *d__, fcomplex *e);

doublereal clansb_(char *norm, char *uplo, integer *n, integer *k, fcomplex *
	ab, integer *ldab, real *work);

doublereal clansp_(char *norm, char *uplo, integer *n, fcomplex *ap, real *
	work);

doublereal clansy_(char *norm, char *uplo, integer *n, fcomplex *a, integer *
	lda, real *work);

doublereal clantb_(char *norm, char *uplo, char *diag, integer *n, integer *k, 
	 fcomplex *ab, integer *ldab, real *work);

doublereal clantp_(char *norm, char *uplo, char *diag, integer *n, fcomplex *
	ap, real *work);

doublereal clantr_(char *norm, char *uplo, char *diag, integer *m, integer *n, 
	 fcomplex *a, integer *lda, real *work);

/* Subroutine */ int clapll_(integer *n, fcomplex *x, integer *incx, fcomplex *
	y, integer *incy, real *ssmin);

/* Subroutine */ int clapmt_(logical *forwrd, integer *m, integer *n, fcomplex 
...
/* Subroutine */ int claqge_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 real *r__, real *c__, real *rowcnd, real *colcnd, real *amax, char *
	equed);

/* Subroutine */ int claqhb_(char *uplo, integer *n, integer *kd, fcomplex *ab, 
	 integer *ldab, real *s, real *scond, real *amax, char *equed);

/* Subroutine */ int claqhe_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 real *s, real *scond, real *amax, char *equed);

/* Subroutine */ int claqhp_(char *uplo, integer *n, fcomplex *ap, real *s, 
	real *scond, real *amax, char *equed);

/* Subroutine */ int claqp2_(integer *m, integer *n, integer *offset, fcomplex 
	*a, integer *lda, integer *jpvt, fcomplex *tau, real *vn1, real *vn2, 
	fcomplex *work);

/* Subroutine */ int claqps_(integer *m, integer *n, integer *offset, integer 
	*nb, integer *kb, fcomplex *a, integer *lda, integer *jpvt, fcomplex *
	tau, real *vn1, real *vn2, fcomplex *auxv, fcomplex *f, integer *ldf);

/* Subroutine */ int claqr0_(logical *wantt, logical *wantz, integer *n, 
	integer *ilo, integer *ihi, fcomplex *h__, integer *ldh, fcomplex *w, 
	integer *iloz, integer *ihiz, fcomplex *z__, integer *ldz, fcomplex *
	work, integer *lwork, integer *info);

/* Subroutine */ int claqr1_(integer *n, fcomplex *h__, integer *ldh, fcomplex *
	s1, fcomplex *s2, fcomplex *v);

/* Subroutine */ int claqr2_(logical *wantt, logical *wantz, integer *n, 
	integer *ktop, integer *kbot, integer *nw, fcomplex *h__, integer *ldh, 
	 integer *iloz, integer *ihiz, fcomplex *z__, integer *ldz, integer *
	ns, integer *nd, fcomplex *sh, fcomplex *v, integer *ldv, integer *nh, 
	fcomplex *t, integer *ldt, integer *nv, fcomplex *wv, integer *ldwv, 
	fcomplex *work, integer *lwork);
...
/* Subroutine */ int claqr5_(logical *wantt, logical *wantz, integer *kacc22, 
	integer *n, integer *ktop, integer *kbot, integer *nshfts, fcomplex *s, 
	 fcomplex *h__, integer *ldh, integer *iloz, integer *ihiz, fcomplex *
	z__, integer *ldz, fcomplex *v, integer *ldv, fcomplex *u, integer *ldu, 
	 integer *nv, fcomplex *wv, integer *ldwv, integer *nh, fcomplex *wh, 
	integer *ldwh);

/* Subroutine */ int claqsb_(char *uplo, integer *n, integer *kd, fcomplex *ab, 
	 integer *ldab, real *s, real *scond, real *amax, char *equed);

/* Subroutine */ int claqsp_(char *uplo, integer *n, fcomplex *ap, real *s, 
	real *scond, real *amax, char *equed);

/* Subroutine */ int claqsy_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 real *s, real *scond, real *amax, char *equed);

/* Subroutine */ int clar1v_(integer *n, integer *b1, integer *bn, real *
	lambda, real *d__, real *l, real *ld, real *lld, real *pivmin, real *
	gaptol, fcomplex *z__, logical *wantnc, integer *negcnt, real *ztz, 
	real *mingma, integer *r__, integer *isuppz, real *nrminv, real *
	resid, real *rqcorr, real *work);

/* Subroutine */ int clar2v_(integer *n, fcomplex *x, fcomplex *y, fcomplex *z__, 
	 integer *incx, real *c__, fcomplex *s, integer *incc);

/* Subroutine */ int clarcm_(integer *m, integer *n, real *a, integer *lda, 
	fcomplex *b, integer *ldb, fcomplex *c__, integer *ldc, real *rwork);

/* Subroutine */ int clarf_(char *side, integer *m, integer *n, fcomplex *v, 
	integer *incv, fcomplex *tau, fcomplex *c__, integer *ldc, fcomplex *
	work);

/* Subroutine */ int clarfb_(char *side, char *trans, char *direct, char *
	storev, integer *m, integer *n, integer *k, fcomplex *v, integer *ldv, 
	fcomplex *t, integer *ldt, fcomplex *c__, integer *ldc, fcomplex *work, 
	integer *ldwork);

/* Subroutine */ int clarfg_(integer *n, fcomplex *alpha, fcomplex *x, integer *
	incx, fcomplex *tau);

/* Subroutine */ int clarfp_(integer *n, fcomplex *alpha, fcomplex *x, integer *
	incx, fcomplex *tau);

/* Subroutine */ int clarft_(char *direct, char *storev, integer *n, integer *
	k, fcomplex *v, integer *ldv, fcomplex *tau, fcomplex *t, integer *ldt);

/* Subroutine */ int clarfx_(char *side, integer *m, integer *n, fcomplex *v, 
	fcomplex *tau, fcomplex *c__, integer *ldc, fcomplex *work);

/* Subroutine */ int clargv_(integer *n, fcomplex *x, integer *incx, fcomplex *
...
/* Subroutine */ int clarrv_(integer *n, real *vl, real *vu, real *d__, real *
	...
	real *wgap, integer *iblock, integer *indexw, real *gers, fcomplex *
	z__, integer *ldz, integer *isuppz, real *work, integer *iwork, 
	integer *info);

/* Subroutine */ int clarscl2_(integer *m, integer *n, real *d__, fcomplex *x, 
	integer *ldx);

/* Subroutine */ int clartg_(fcomplex *f, fcomplex *g, real *cs, fcomplex *sn, 
	fcomplex *r__);

/* Subroutine */ int clartv_(integer *n, fcomplex *x, integer *incx, fcomplex *
	y, integer *incy, real *c__, fcomplex *s, integer *incc);

/* Subroutine */ int clarz_(char *side, integer *m, integer *n, integer *l, 
	fcomplex *v, integer *incv, fcomplex *tau, fcomplex *c__, integer *ldc, 
	fcomplex *work);

/* Subroutine */ int clarzb_(char *side, char *trans, char *direct, char *
	storev, integer *m, integer *n, integer *k, integer *l, fcomplex *v, 
	integer *ldv, fcomplex *t, integer *ldt, fcomplex *c__, integer *ldc, 
	fcomplex *work, integer *ldwork);
...
/* Subroutine */ int clascl_(char *type__, integer *kl, integer *ku, real *
	cfrom, real *cto, integer *m, integer *n, fcomplex *a, integer *lda, 
	integer *info);

/* Subroutine */ int clascl2_(integer *m, integer *n, real *d__, fcomplex *x, 
	integer *ldx);

/* Subroutine */ int claset_(char *uplo, integer *m, integer *n, fcomplex *
	alpha, fcomplex *beta, fcomplex *a, integer *lda);

/* Subroutine */ int clasr_(char *side, char *pivot, char *direct, integer *m, 
	 integer *n, real *c__, real *s, fcomplex *a, integer *lda);

/* Subroutine */ int classq_(integer *n, fcomplex *x, integer *incx, real *
	scale, real *sumsq);

/* Subroutine */ int claswp_(integer *n, fcomplex *a, integer *lda, integer *
...
/* Subroutine */ int clatbs_(char *uplo, char *trans, char *diag, char *
	normin, integer *n, integer *kd, fcomplex *ab, integer *ldab, fcomplex *
	x, real *scale, real *cnorm, integer *info);

/* Subroutine */ int clatdf_(integer *ijob, integer *n, fcomplex *z__, integer 
	*ldz, fcomplex *rhs, real *rdsum, real *rdscal, integer *ipiv, integer 
	*jpiv);

/* Subroutine */ int clatps_(char *uplo, char *trans, char *diag, char *
	normin, integer *n, fcomplex *ap, fcomplex *x, real *scale, real *cnorm, 
	 integer *info);

/* Subroutine */ int clatrd_(char *uplo, integer *n, integer *nb, fcomplex *a, 
	integer *lda, real *e, fcomplex *tau, fcomplex *w, integer *ldw);

/* Subroutine */ int clatrs_(char *uplo, char *trans, char *diag, char *
	normin, integer *n, fcomplex *a, integer *lda, fcomplex *x, real *scale, 
	 real *cnorm, integer *info);

/* Subroutine */ int clatrz_(integer *m, integer *n, integer *l, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *work);

/* Subroutine */ int clatzm_(char *side, integer *m, integer *n, fcomplex *v, 
	integer *incv, fcomplex *tau, fcomplex *c1, fcomplex *c2, integer *ldc, 
	fcomplex *work);

/* Subroutine */ int clauu2_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *info);

/* Subroutine */ int clauum_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *info);

/* Subroutine */ int cpbcon_(char *uplo, integer *n, integer *kd, fcomplex *ab, 
	 integer *ldab, real *anorm, real *rcond, fcomplex *work, real *rwork, 
	integer *info);

/* Subroutine */ int cpbequ_(char *uplo, integer *n, integer *kd, fcomplex *ab, 
	 integer *ldab, real *s, real *scond, real *amax, integer *info);

/* Subroutine */ int cpbrfs_(char *uplo, integer *n, integer *kd, integer *
	nrhs, fcomplex *ab, integer *ldab, fcomplex *afb, integer *ldafb, 
	fcomplex *b, integer *ldb, fcomplex *x, integer *ldx, real *ferr, real *
	berr, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cpbstf_(char *uplo, integer *n, integer *kd, fcomplex *ab, 
	 integer *ldab, integer *info);

/* Subroutine */ int cpbsv_(char *uplo, integer *n, integer *kd, integer *
	nrhs, fcomplex *ab, integer *ldab, fcomplex *b, integer *ldb, integer *
	info);

/* Subroutine */ int cpbsvx_(char *fact, char *uplo, integer *n, integer *kd, 
	integer *nrhs, fcomplex *ab, integer *ldab, fcomplex *afb, integer *
	ldafb, char *equed, real *s, fcomplex *b, integer *ldb, fcomplex *x, 
	integer *ldx, real *rcond, real *ferr, real *berr, fcomplex *work, 
	real *rwork, integer *info);

/* Subroutine */ int cpbtf2_(char *uplo, integer *n, integer *kd, fcomplex *ab, 
	 integer *ldab, integer *info);

/* Subroutine */ int cpbtrf_(char *uplo, integer *n, integer *kd, fcomplex *ab, 
	 integer *ldab, integer *info);
...
/* Subroutine */ int cpftrf_(char *transr, char *uplo, integer *n, fcomplex *a, 
	 integer *info);

/* Subroutine */ int cpftri_(char *transr, char *uplo, integer *n, fcomplex *a, 
	 integer *info);

/* Subroutine */ int cpftrs_(char *transr, char *uplo, integer *n, integer *
	nrhs, fcomplex *a, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cpocon_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 real *anorm, real *rcond, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cpoequ_(integer *n, fcomplex *a, integer *lda, real *s, 
	real *scond, real *amax, integer *info);

/* Subroutine */ int cpoequb_(integer *n, fcomplex *a, integer *lda, real *s, 
	real *scond, real *amax, integer *info);

/* Subroutine */ int cporfs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, fcomplex *af, integer *ldaf, fcomplex *b, integer *ldb, 
	 fcomplex *x, integer *ldx, real *ferr, real *berr, fcomplex *work, 
	real *rwork, integer *info);

/* Subroutine */ int cporfsx_(char *uplo, char *equed, integer *n, integer *
	nrhs, fcomplex *a, integer *lda, fcomplex *af, integer *ldaf, real *s, 
	fcomplex *b, integer *ldb, fcomplex *x, integer *ldx, real *rcond, real 
	*berr, integer *n_err_bnds__, real *err_bnds_norm__, real *
	err_bnds_comp__, integer *nparams, real *params, fcomplex *work, real *
	rwork, integer *info);

/* Subroutine */ int cposv_(char *uplo, integer *n, integer *nrhs, fcomplex *a, 
	 integer *lda, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cposvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, fcomplex *a, integer *lda, fcomplex *af, integer *ldaf, char *
	equed, real *s, fcomplex *b, integer *ldb, fcomplex *x, integer *ldx, 
	real *rcond, real *ferr, real *berr, fcomplex *work, real *rwork, 
	integer *info);
...
/* Subroutine */ int cpotf2_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *info);

/* Subroutine */ int cpotrf_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *info);

/* Subroutine */ int cpotri_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *info);

/* Subroutine */ int cpotrs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cppcon_(char *uplo, integer *n, fcomplex *ap, real *anorm, 
	 real *rcond, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cppequ_(char *uplo, integer *n, fcomplex *ap, real *s, 
	real *scond, real *amax, integer *info);

/* Subroutine */ int cpprfs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	ap, fcomplex *afp, fcomplex *b, integer *ldb, fcomplex *x, integer *ldx, 
	real *ferr, real *berr, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cppsv_(char *uplo, integer *n, integer *nrhs, fcomplex *
	ap, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cppsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, fcomplex *ap, fcomplex *afp, char *equed, real *s, fcomplex *b, 
	integer *ldb, fcomplex *x, integer *ldx, real *rcond, real *ferr, real 
	*berr, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int cpptrf_(char *uplo, integer *n, fcomplex *ap, integer *
	info);

/* Subroutine */ int cpptri_(char *uplo, integer *n, fcomplex *ap, integer *
	info);

/* Subroutine */ int cpptrs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	ap, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cpstf2_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *piv, integer *rank, real *tol, real *work, integer *info);

/* Subroutine */ int cpstrf_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *piv, integer *rank, real *tol, real *work, integer *info);

/* Subroutine */ int cptcon_(integer *n, real *d__, fcomplex *e, real *anorm, 
	real *rcond, real *rwork, integer *info);

/* Subroutine */ int cpteqr_(char *compz, integer *n, real *d__, real *e, 
	fcomplex *z__, integer *ldz, real *work, integer *info);

/* Subroutine */ int cptrfs_(char *uplo, integer *n, integer *nrhs, real *d__, 
	 fcomplex *e, real *df, fcomplex *ef, fcomplex *b, integer *ldb, fcomplex 
	*x, integer *ldx, real *ferr, real *berr, fcomplex *work, real *rwork, 
	integer *info);

/* Subroutine */ int cptsv_(integer *n, integer *nrhs, real *d__, fcomplex *e, 
	fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cptsvx_(char *fact, integer *n, integer *nrhs, real *d__, 
	 fcomplex *e, real *df, fcomplex *ef, fcomplex *b, integer *ldb, fcomplex 
	*x, integer *ldx, real *rcond, real *ferr, real *berr, fcomplex *work, 
	real *rwork, integer *info);

/* Subroutine */ int cpttrf_(integer *n, real *d__, fcomplex *e, integer *info);

/* Subroutine */ int cpttrs_(char *uplo, integer *n, integer *nrhs, real *d__, 
	 fcomplex *e, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int cptts2_(integer *iuplo, integer *n, integer *nrhs, real *
	d__, fcomplex *e, fcomplex *b, integer *ldb);

/* Subroutine */ int crot_(integer *n, fcomplex *cx, integer *incx, fcomplex *
	cy, integer *incy, real *c__, fcomplex *s);

/* Subroutine */ int cspcon_(char *uplo, integer *n, fcomplex *ap, integer *
	ipiv, real *anorm, real *rcond, fcomplex *work, integer *info);

/* Subroutine */ int cspmv_(char *uplo, integer *n, fcomplex *alpha, fcomplex *
	ap, fcomplex *x, integer *incx, fcomplex *beta, fcomplex *y, integer *
	incy);

/* Subroutine */ int cspr_(char *uplo, integer *n, fcomplex *alpha, fcomplex *x, 
	 integer *incx, fcomplex *ap);

/* Subroutine */ int csprfs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	ap, fcomplex *afp, integer *ipiv, fcomplex *b, integer *ldb, fcomplex *x, 
	 integer *ldx, real *ferr, real *berr, fcomplex *work, real *rwork, 
	integer *info);

/* Subroutine */ int cspsv_(char *uplo, integer *n, integer *nrhs, fcomplex *
	ap, integer *ipiv, fcomplex *b, integer *ldb, integer *info);
...
/* Subroutine */ int csptrf_(char *uplo, integer *n, fcomplex *ap, integer *
	ipiv, integer *info);

/* Subroutine */ int csptri_(char *uplo, integer *n, fcomplex *ap, integer *
	ipiv, fcomplex *work, integer *info);

/* Subroutine */ int csptrs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	ap, integer *ipiv, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int csrscl_(integer *n, real *sa, fcomplex *sx, integer *incx);
...
/* Subroutine */ int cstegr_(char *jobz, char *range, integer *n, real *d__, 
	...
	integer *m, real *w, fcomplex *z__, integer *ldz, integer *isuppz, 
...
/* Subroutine */ int cstein_(integer *n, real *d__, real *e, integer *m, real 
	*w, integer *iblock, integer *isplit, fcomplex *z__, integer *ldz, 
...
/* Subroutine */ int cstemr_(char *jobz, char *range, integer *n, real *d__, 
	...
	real *w, fcomplex *z__, integer *ldz, integer *nzc, integer *isuppz, 
...
/* Subroutine */ int csycon_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *ipiv, real *anorm, real *rcond, fcomplex *work, integer *
	info);

/* Subroutine */ int csyequb_(char *uplo, integer *n, fcomplex *a, integer *
	lda, real *s, real *scond, real *amax, fcomplex *work, integer *info);

/* Subroutine */ int csymv_(char *uplo, integer *n, fcomplex *alpha, fcomplex *
	a, integer *lda, fcomplex *x, integer *incx, fcomplex *beta, fcomplex *y, 
	 integer *incy);

/* Subroutine */ int csyr_(char *uplo, integer *n, fcomplex *alpha, fcomplex *x, 
	 integer *incx, fcomplex *a, integer *lda);

/* Subroutine */ int csyrfs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, fcomplex *af, integer *ldaf, integer *ipiv, fcomplex *
	b, integer *ldb, fcomplex *x, integer *ldx, real *ferr, real *berr, 
	fcomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int csysv_(char *uplo, integer *n, integer *nrhs, fcomplex *a, 
	 integer *lda, integer *ipiv, fcomplex *b, integer *ldb, fcomplex *work, 
	 integer *lwork, integer *info);
...
/* Subroutine */ int csytf2_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *ipiv, integer *info);

/* Subroutine */ int csytrf_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *ipiv, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int csytri_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 integer *ipiv, fcomplex *work, integer *info);

/* Subroutine */ int csytrs_(char *uplo, integer *n, integer *nrhs, fcomplex *
	a, integer *lda, integer *ipiv, fcomplex *b, integer *ldb, integer *
	info);

/* Subroutine */ int ctbcon_(char *norm, char *uplo, char *diag, integer *n, 
	integer *kd, fcomplex *ab, integer *ldab, real *rcond, fcomplex *work, 
	real *rwork, integer *info);

/* Subroutine */ int ctbrfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *kd, integer *nrhs, fcomplex *ab, integer *ldab, fcomplex *b, 
	integer *ldb, fcomplex *x, integer *ldx, real *ferr, real *berr, 
	fcomplex *work, real *rwork, integer *info);
...
/* Subroutine */ int ctfsm_(char *transr, char *side, char *uplo, char *trans, 
	 char *diag, integer *m, integer *n, fcomplex *alpha, fcomplex *a, 
	fcomplex *b, integer *ldb);

/* Subroutine */ int ctftri_(char *transr, char *uplo, char *diag, integer *n, 
	 fcomplex *a, integer *info);

/* Subroutine */ int ctfttp_(char *transr, char *uplo, integer *n, fcomplex *
	arf, fcomplex *ap, integer *info);

/* Subroutine */ int ctfttr_(char *transr, char *uplo, integer *n, fcomplex *
	arf, fcomplex *a, integer *lda, integer *info);

/* Subroutine */ int ctgevc_(char *side, char *howmny, logical *select, 
	integer *n, fcomplex *s, integer *lds, fcomplex *p, integer *ldp, 
	fcomplex *vl, integer *ldvl, fcomplex *vr, integer *ldvr, integer *mm, 
	integer *m, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int ctgex2_(logical *wantq, logical *wantz, integer *n, 
	fcomplex *a, integer *lda, fcomplex *b, integer *ldb, fcomplex *q, 
	integer *ldq, fcomplex *z__, integer *ldz, integer *j1, integer *info);

/* Subroutine */ int ctgexc_(logical *wantq, logical *wantz, integer *n, 
	fcomplex *a, integer *lda, fcomplex *b, integer *ldb, fcomplex *q, 
	integer *ldq, fcomplex *z__, integer *ldz, integer *ifst, integer *
	ilst, integer *info);

/* Subroutine */ int ctgsen_(integer *ijob, logical *wantq, logical *wantz, 
	logical *select, integer *n, fcomplex *a, integer *lda, fcomplex *b, 
	integer *ldb, fcomplex *alpha, fcomplex *beta, fcomplex *q, integer *ldq, 
	 fcomplex *z__, integer *ldz, integer *m, real *pl, real *pr, real *
	dif, fcomplex *work, integer *lwork, integer *iwork, integer *liwork, 
	integer *info);

/* Subroutine */ int ctgsja_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *p, integer *n, integer *k, integer *l, fcomplex *a, integer *
	lda, fcomplex *b, integer *ldb, real *tola, real *tolb, real *alpha, 
	real *beta, fcomplex *u, integer *ldu, fcomplex *v, integer *ldv, 
	fcomplex *q, integer *ldq, fcomplex *work, integer *ncycle, integer *
	info);

/* Subroutine */ int ctgsna_(char *job, char *howmny, logical *select, 
	integer *n, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, 
	fcomplex *vl, integer *ldvl, fcomplex *vr, integer *ldvr, real *s, real 
	*dif, integer *mm, integer *m, fcomplex *work, integer *lwork, integer 
	*iwork, integer *info);

/* Subroutine */ int ctgsy2_(char *trans, integer *ijob, integer *m, integer *
	n, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, fcomplex *c__, 
	integer *ldc, fcomplex *d__, integer *ldd, fcomplex *e, integer *lde, 
	fcomplex *f, integer *ldf, real *scale, real *rdsum, real *rdscal, 
	integer *info);

/* Subroutine */ int ctgsyl_(char *trans, integer *ijob, integer *m, integer *
	n, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, fcomplex *c__, 
	integer *ldc, fcomplex *d__, integer *ldd, fcomplex *e, integer *lde, 
	fcomplex *f, integer *ldf, real *scale, real *dif, fcomplex *work, 
	integer *lwork, integer *iwork, integer *info);

/* Subroutine */ int ctpcon_(char *norm, char *uplo, char *diag, integer *n, 
	fcomplex *ap, real *rcond, fcomplex *work, real *rwork, integer *info);

/* Subroutine */ int ctprfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, fcomplex *ap, fcomplex *b, integer *ldb, fcomplex *x, 
	integer *ldx, real *ferr, real *berr, fcomplex *work, real *rwork, 
	integer *info);

/* Subroutine */ int ctptri_(char *uplo, char *diag, integer *n, fcomplex *ap, 
	integer *info);

/* Subroutine */ int ctptrs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, fcomplex *ap, fcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int ctpttf_(char *transr, char *uplo, integer *n, fcomplex *
	ap, fcomplex *arf, integer *info);

/* Subroutine */ int ctpttr_(char *uplo, integer *n, fcomplex *ap, fcomplex *a, 
	integer *lda, integer *info);

/* Subroutine */ int ctrcon_(char *norm, char *uplo, char *diag, integer *n, 
	fcomplex *a, integer *lda, real *rcond, fcomplex *work, real *rwork, 
	integer *info);

/* Subroutine */ int ctrevc_(char *side, char *howmny, logical *select, 
	integer *n, fcomplex *t, integer *ldt, fcomplex *vl, integer *ldvl, 
	fcomplex *vr, integer *ldvr, integer *mm, integer *m, fcomplex *work, 
	real *rwork, integer *info);

/* Subroutine */ int ctrexc_(char *compq, integer *n, fcomplex *t, integer *
	ldt, fcomplex *q, integer *ldq, integer *ifst, integer *ilst, integer *
	info);

/* Subroutine */ int ctrrfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, 
	fcomplex *x, integer *ldx, real *ferr, real *berr, fcomplex *work, real 
	*rwork, integer *info);

/* Subroutine */ int ctrsen_(char *job, char *compq, logical *select, integer 
	*n, fcomplex *t, integer *ldt, fcomplex *q, integer *ldq, fcomplex *w, 
	integer *m, real *s, real *sep, fcomplex *work, integer *lwork, 
	integer *info);

/* Subroutine */ int ctrsna_(char *job, char *howmny, logical *select, 
	integer *n, fcomplex *t, integer *ldt, fcomplex *vl, integer *ldvl, 
	fcomplex *vr, integer *ldvr, real *s, real *sep, integer *mm, integer *
	m, fcomplex *work, integer *ldwork, real *rwork, integer *info);

/* Subroutine */ int ctrsyl_(char *trana, char *tranb, integer *isgn, integer 
	*m, integer *n, fcomplex *a, integer *lda, fcomplex *b, integer *ldb, 
	fcomplex *c__, integer *ldc, real *scale, integer *info);

/* Subroutine */ int ctrti2_(char *uplo, char *diag, integer *n, fcomplex *a, 
	integer *lda, integer *info);

/* Subroutine */ int ctrtri_(char *uplo, char *diag, integer *n, fcomplex *a, 
	integer *lda, integer *info);
...
/* Subroutine */ int ctrttf_(char *transr, char *uplo, integer *n, fcomplex *a, 
	 integer *lda, fcomplex *arf, integer *info);

/* Subroutine */ int ctrttp_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *ap, integer *info);

/* Subroutine */ int ctzrqf_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, integer *info);

/* Subroutine */ int ctzrzf_(integer *m, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cung2l_(integer *m, integer *n, integer *k, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *work, integer *info);

/* Subroutine */ int cung2r_(integer *m, integer *n, integer *k, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *work, integer *info);

/* Subroutine */ int cungbr_(char *vect, integer *m, integer *n, integer *k, 
	fcomplex *a, integer *lda, fcomplex *tau, fcomplex *work, integer *lwork, 
	 integer *info);

/* Subroutine */ int cunghr_(integer *n, integer *ilo, integer *ihi, fcomplex *
	a, integer *lda, fcomplex *tau, fcomplex *work, integer *lwork, integer 
	*info);

/* Subroutine */ int cungl2_(integer *m, integer *n, integer *k, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *work, integer *info);

/* Subroutine */ int cunglq_(integer *m, integer *n, integer *k, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *work, integer *lwork, integer *
	info);

/* Subroutine */ int cungql_(integer *m, integer *n, integer *k, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *work, integer *lwork, integer *
	info);

/* Subroutine */ int cungqr_(integer *m, integer *n, integer *k, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *work, integer *lwork, integer *
	info);

/* Subroutine */ int cungr2_(integer *m, integer *n, integer *k, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *work, integer *info);

/* Subroutine */ int cungrq_(integer *m, integer *n, integer *k, fcomplex *a, 
	integer *lda, fcomplex *tau, fcomplex *work, integer *lwork, integer *
	info);

/* Subroutine */ int cungtr_(char *uplo, integer *n, fcomplex *a, integer *lda, 
	 fcomplex *tau, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cunm2l_(char *side, char *trans, integer *m, integer *n, 
	integer *k, fcomplex *a, integer *lda, fcomplex *tau, fcomplex *c__, 
	integer *ldc, fcomplex *work, integer *info);
...
/* Subroutine */ int cunmbr_(char *vect, char *side, char *trans, integer *m, 
	integer *n, integer *k, fcomplex *a, integer *lda, fcomplex *tau, 
	fcomplex *c__, integer *ldc, fcomplex *work, integer *lwork, integer *
	info);

/* Subroutine */ int cunmhr_(char *side, char *trans, integer *m, integer *n, 
	integer *ilo, integer *ihi, fcomplex *a, integer *lda, fcomplex *tau, 
	fcomplex *c__, integer *ldc, fcomplex *work, integer *lwork, integer *
	info);
...
/* Subroutine */ int cunmlq_(char *side, char *trans, integer *m, integer *n, 
	integer *k, fcomplex *a, integer *lda, fcomplex *tau, fcomplex *c__, 
	integer *ldc, fcomplex *work, integer *lwork, integer *info);
...
/* Subroutine */ int cunmr3_(char *side, char *trans, integer *m, integer *n, 
	integer *k, integer *l, fcomplex *a, integer *lda, fcomplex *tau, 
	fcomplex *c__, integer *ldc, fcomplex *work, integer *info);
...
/* Subroutine */ int cunmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, fcomplex *a, integer *lda, fcomplex *tau, fcomplex *c__, 
	integer *ldc, fcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int cupgtr_(char *uplo, integer *n, fcomplex *ap, fcomplex *
	tau, fcomplex *q, integer *ldq, fcomplex *work, integer *info);

/* Subroutine */ int cupmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, fcomplex *ap, fcomplex *tau, fcomplex *c__, integer *ldc, 
	fcomplex *work, integer *info);
...
integer icmax1_(integer *n, fcomplex *cx, integer *incx);

integer ieeeck_(integer *ispec, real *zero, real *one);

integer ilaclc_(integer *m, integer *n, fcomplex *a, integer *lda);

integer ilaclr_(integer *m, integer *n, fcomplex *a, integer *lda);
...
doublereal scsum1_(integer *n, fcomplex *cx, integer *incx);
...
/* Subroutine */ int zcgesv_(integer *n, integer *nrhs, doublecomplex *a, 
	...
	doublecomplex *x, integer *ldx, doublecomplex *work, fcomplex *swork, 
...
/* Double fcomplex */ VOID zladiv_(doublecomplex * ret_val, doublecomplex *x, 
	doublecomplex *y);
...
/* Subroutine */ int zlag2c_(integer *m, integer *n, doublecomplex *a, 
	integer *lda, fcomplex *sa, integer *ldsa, integer *info);
